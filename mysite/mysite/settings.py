...
SECRET_KEY = 'django-insecure-$gf$a$&z^pk9+18)1qtn5j3+6xn&d5-f@s%%j26ju(c6r4av5k'

DEBUG = True

ALLOWED_HOSTS = ['claudespeed21333.pythonanywhere.com']
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/home/claudespeed21333/webhook/mysite/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
